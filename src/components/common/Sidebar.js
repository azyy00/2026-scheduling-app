...
const instructorLinks = [{ to: '/instructor/dashboard', label: 'My Schedule' }];
const studentLinks    = [{ to: '/student/schedule',     label: 'My Schedule' }];
...
const Sidebar = () => {
  ...
  return (
    <aside className="w-56 bg-white border-r border-gray-200 min-h-screen flex flex-col py-6">
      <p className="text-[10px] uppercase tracking-widest text-gray-400 px-5 mb-3 font-bold">Navigation</p>
